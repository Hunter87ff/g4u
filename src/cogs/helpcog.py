...
roleemb = discord.Embed(
 ...
 color=0xf0ff0f)
utilemb = discord.Embed(
 description=
 f"{hel_p}__**Utility**__\n`addemoji`, `tts`, `avatar`, `banner`, `botinfo`, `ping`, `embed`, `embed_img`, `member_count`, `nick`, `nitro`, `prefix`, `react`, `server_av`, `serverinfo`, `toss`, `userinfo`, `whoiss`, `uptime`, `vote`, `support`, `invite`",
 color=0xf0ff0f)
...
class Dropdown(discord.ui.Select):
	...
	def __init__(self):
		...
		options = [
		 ...
		 discord.SelectOption(label='Esports',
		                      description='Select For Tournament Commands'),
		 discord.SelectOption(label='Music',
		                      description='Select For Music Commands'),
		 discord.SelectOption(label='Moderation',
		                      description='Select For Noderation Commands'),
		 discord.SelectOption(label='Utility',
		                      description='Select For Utility Commands'),
		...
		super().__init__(placeholder='Choose Command Category...',
		                 min_values=1,
		                 max_values=1,
		                 options=options)
	...
	async def callback(self, interaction: discord.Interaction):
		...
		if self.values[0] == "Music":
			await interaction.response.edit_message(embed=musicemb.set_thumbnail(
			 url=get_thum(ctx)).set_footer(text=f"Requested By {interaction.user}",
			                               icon_url=interaction.user.display_avatar))
		if self.values[0] == "Moderation":
			await interaction.response.edit_message(embed=modemb.set_thumbnail(
			 url=get_thum(ctx)).set_footer(text=f"Requested By {interaction.user}",
			                               icon_url=interaction.user.display_avatar))
		if self.values[0] == "Esports":
			await interaction.response.edit_message(embed=espemb.set_thumbnail(
			 url=get_thum(ctx)).set_footer(text=f"Requested By {interaction.user}",
			                               icon_url=interaction.user.display_avatar))
		if self.values[0] == "Main":
			await interaction.response.edit_message(embed=helpemb.set_thumbnail(
			 url=get_thum(ctx)).set_footer(text=f"Requested By {interaction.user}",
			                               icon_url=interaction.user.display_avatar))
		if self.values[0] == "Utility":
			await interaction.response.edit_message(embed=utilemb.set_thumbnail(
			 url=get_thum(ctx)).set_footer(text=f"Requested By {interaction.user}",
			                               icon_url=interaction.user.display_avatar))
		if self.values[0] == "Role":
			await interaction.response.edit_message(embed=roleemb.set_thumbnail(
			 url=get_thum(ctx)).set_footer(text=f"Requested By {interaction.user}",
			                               icon_url=interaction.user.display_avatar))
...
class Helper(commands.Cog):
	...
	async def help(self, ctx):
		...
		for opt in buttons:
			view.add_item(opt)
		await ctx.send(embed=helpemb.set_thumbnail(url=get_thum(ctx)).set_footer(
	...
	async def Music(self, ctx):
		...
		for bt in buttons:
			view.add_item(bt)
		await ctx.send(embed=musicemb.set_thumbnail(url=get_thum(ctx)).set_footer(
		 text=f"Requested By {ctx.author}", icon_url=ctx.author.display_avatar),
		               view=view)
	...
	async def Moedration(self, ctx):
		...
		for bt in buttons:
			view.add_item(bt)
		await ctx.send(embed=modemb.set_thumbnail(url=get_thum(ctx)).set_footer(
		 text=f"Requested By {ctx.author}", icon_url=ctx.author.display_avatar),
		               view=view)
	...
	async def Esports(self, ctx):
		...
		for bt in buttons:
			view.add_item(bt)
		await ctx.send(embed=espemb.set_thumbnail(url=get_thum(ctx)).set_footer(
		 text=f"Requested By {ctx.author}", icon_url=ctx.author.display_avatar),
		               view=view)
	...
	async def Role(self, ctx):
		...
		for bt in buttons:
			view.add_item(bt)
		await ctx.send(embed=roleemb.set_thumbnail(url=get_thum(ctx)).set_footer(
		 text=f"Requested By {ctx.author}", icon_url=ctx.author.display_avatar),
		               view=view)
	...
	async def Utility(self, ctx):
		...
		for bt in buttons:
			view.add_item(bt)
		await ctx.send(embed=utilemb.set_thumbnail(url=get_thum(ctx)).set_footer(
		 text=f"Requested By {ctx.author}", icon_url=ctx.author.display_avatar),
		               view=view)
...
#channel Related
	...
	async def channel_del(self, ctx):
		em = discord.Embed(
		 description=
		 "Aliases : `chd`\nUsage : `channel_del [channels...]`\nExample : `&channel_del #general #updates`",
		 color=0x00ff00)
		await ctx.send(embed=em)
	...
	async def channel_make(self, ctx):
		em = discord.Embed(
		 description=
		 "Aliases : `chm`\nUsage : `channel_make [names...]`\nExample : `&channel_make general updates`",
		 color=0x00ff00)
		await ctx.send(embed=em)
	...
	async def create_channel(self, ctx):
		em = discord.Embed(
		 description=
		 "Aliases : `cch`\nUsage : `create_channel <category> [names...]`\nExample : `&create_channel 32745216342163 general memes announcements`",
		 color=0x00ff00)
		await ctx.send(embed=em)
	...
	async def delete_category(self, ctx):
		em = discord.Embed(
		 description=
		 "Aliases : `dc`\nUsage : `delete_category <category>`\nExample : `&dc 7654123645287`\nDescription : `Use This Command To Delete A Hole Category | You Must Have Administrator Permission`",
		 color=0x00ff00)
		await ctx.send(embed=em)
...
#role Related
	...
	async def port(self, ctx):
		em = discord.Embed(
		 description=
		 "Aliases : `Not Available`\nUsage : `port <role1> <role2>`\nExample : `&port @ipl-group1 @ipl-group2`",
		 color=0x00ff00)
		await ctx.send(embed=em)
	...
	async def create_roles(self, ctx):
		em = discord.Embed(
		 description=
		 "Aliases : `croles`\nUsage : `create_roles [Names...]`\nExample : `&create_roles family male female`",
		 color=0x00ff00)
		await ctx.send(embed=em)
	...
	async def remove_role(self, ctx):
		em = discord.Embed(
		 description=
		 "Aliases : `Not Available`\nUsage : `remove_role <role> [memebrs...]`\nExample : `&remove_role @Male @hunter`",
		 color=0x00ff00)
		await ctx.send(embed=em)
	...
	async def del_roles(self, ctx):
		em = discord.Embed(
		 description=
		 "Aliases : `droles`\nUsage : `del_roles [roles...]`\nExample : `&del_roles @group1 @group2`",
		 color=0x00ff00)
		await ctx.send(embed=em)
	...
	async def remove_role_members(self, ctx):
		em = discord.Embed(
		 description=
		 "Aliases : `ra_role`\nUsage : `ra_role <roles>`\nExample : `&ra_role @humans`\nDescription : Use This Command To Remove A Role From Everyone",
		 color=0x00ff00)
		await ctx.send(embed=em)
	...
	async def hide_roles(self, ctx):
		em = discord.Embed(
		 description=
		 "Aliases : `hr`\nUsage : `hide_roles`\nExample : `&hide_roles`\nDescription : Use this command to hide all roles in memebr list",
		 color=0x00ff00)
		await ctx.send(embed=em)
...
#Esports Related
	...
	async def change_slot(self, ctx):
		em = discord.Embed(
		 description=
		 "Aliases : `cs`\nUsage : `change_slot <exact_teame> <mention>`\nExample : `&change_slot HG ESPORTS @hunter `\nDescription: Use This Command By Replying The Group Message! And Use The Exact Slot Detail Otherwise It'll Not Work",
		 color=0x00ff00)
		em.set_image(
		 url=
		 "https://media.discordapp.net/attachments/892682901404123137/1057515803823587440/Debut_2022-12-28_09_58_39.png?width=879&height=462"
		)
		await ctx.send(embed=em)
	...
	async def tourneys(self, ctx):
		em = discord.Embed(
		 description=
		 "Aliases : `Not Available`\nUsage : `tourneys`\nExample : `&tourneys`\nDescription: By using this command! you'll get a list of ongoing tournaments to register",
		 color=0x00ff00)
		await ctx.send(embed=em)
	...
	async def faketag(self, ctx):
		em = discord.Embed(
		 description=
		 "Aliases : `Not Available`\nUsage : `faketag <registration_channel>`\nExample : `&faketag #register-here`\ndescription : Use This Command To enable/disable Faketag Filter Of A Tournament",
		 color=0x00ff00)
		await ctx.send(embed=em)
...
#Utils Related
	...
	async def tts(self, ctx):
		em = discord.Embed(
		 description=
		 f"Aliases : `Not Available`\nUsage : `tts <sentense>`\nExample : `&tts hello {ctx.author.name}`",
		 color=0x00ff00)
		await ctx.send(embed=em)
	...
	async def addemoji(self, ctx):
		em = discord.Embed(
		 description=
		 "Aliases : `Not Available`\nUsage : `addemoji <emoji>`\nExample : `&addemoji` <:vf:947194381172084767>",
		 color=0x00ff00)
		await ctx.send(embed=em)
	...
	async def avatar(self, ctx):
		em = discord.Embed(
		 description=
		 "Aliases : `av`\nUsage : `avatar|av [user=None]`\nExample : `&av @hunter87`\ndescription : Use This Command To Get Avatar Of User",
		 color=0x00ff00)
		await ctx.send(embed=em)
	...
	async def botinfo(self, ctx):
		em = discord.Embed(
		 description=
		 "Aliases : `bi`\nUsage : `botinfo`\nDescription : `Use This Command To Get The Details About Me`",
		 color=0x00ff00)
		await ctx.send(embed=em)
	...
	async def embed(self, ctx):
		em = discord.Embed(
		 description=
		 f"Aliases : `emb`\nUsage : `embed <message>`\nExample : `&emb hello` {ctx.author.mention}",
		 color=0x00ff00)
		await ctx.send(embed=em)
	...
	async def embed_img(self, ctx):
		em = discord.Embed(
		 description=
		 f"Aliases : `em`\nUsage : `embed <image_url> <message>`\nExample : `&emb https://bit.ly/3d39vhz hello` {ctx.author.mention}",
		 color=0x00ff00)
		await ctx.send(embed=em)
	...
	async def vote(self, ctx):
		em = discord.Embed(
		 description=f"Aliases : `Not Available`\nUsage : `vote`\nExample : `&vote`",
		 color=0x00ff00)
		await ctx.send(embed=em)
	...
	async def nick(self, ctx):
		em = discord.Embed(
		 description=
		 f"Aliases : `Not Available`\nUsage : `nick <member> <new_name>`\nExample : `&nick` {ctx.author.mention} akash friend",
		 color=0x00ff00)
		await ctx.send(embed=em)
	...
	async def whoiss(self, ctx):
		em = discord.Embed(
		 description=
		 f"Aliases : `Not Available`\nUsage : `whoiss <member>`\nExample : `&whoiss` {ctx.author.mention}",
		 color=0x00ff00)
		await ctx.send(embed=em)
	...
	async def react(self, ctx):
		em = discord.Embed(
		 description=
		 f"Aliases : `Not Available`\nUsage : `react <message_id> <emoji>`\nExample : `&react 7456213462634` <:vf:947194381172084767>",
		 color=0x00ff00)
		await ctx.send(embed=em)
...
#Music Related
	...
	async def play(self, ctx):
		em = discord.Embed(
		 description=
		 "Aliases : `p`\nUsage : `play <Song_name>`\nExample : `&p Faded`\nNote : You Mus Joined A VoiceChannel",
		 color=0x00ff00)
		await ctx.send(embed=em)
	...
	async def pause(self, ctx):
		em = discord.Embed(
		 description="Aliases : `Not Available`\nUsage : `pause`\nExample : `&pause`",
		 color=0x00ff00)
		await ctx.send(embed=em)
	...
	async def loop(self, ctx):
		em = discord.Embed(
		 description=
		 "Aliases : `Not Available`\nUsage : `loop`\nExample : `&loop`\nDescription: Use This Command To Loop The Current Audio!",
		 color=0x00ff00)
		await ctx.send(embed=em)
